-- Close policies that exposed every referral code and insurance metadata.
...
-- Only the service-role referral claim function may attach a registered user
-- to an invitation. Existing owner/admin read policies remain unchanged.
