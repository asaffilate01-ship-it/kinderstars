...
const becomeSteps = [
  {
    ...
    desc: "Füllen Sie unser Kontaktformular aus („Kindertagespflegeperson werden") oder schreiben Sie an info@kinderstars.de. Wir vereinbaren ein persönliches Gespräch.",
  },
  {
    icon: ShieldCheck,
